...
public class JoinUI extends JFrame {
    ...
    private static final String liter1 = "나눔스퀘어라운드 Regular";
    private static final String liter2 = "나눔스퀘어라운드 ExtraBold";
    private static final String liter3 = "굴림";
    ...
    public JoinUI(Client client) {
        ...
        pwdPassword.setFont(new Font(liter3, Font.PLAIN, 18));
        pwdPassword.setBounds(31, 172, 312, 45);
        contentPane.add(pwdPassword);
        
        passwordField = new JPasswordField();
        passwordField.setFont(new Font(liter3, Font.PLAIN, 18));
        passwordField.setBounds(31, 237, 312, 45);
        contentPane.add(passwordField);

        IDField = new JTextField();
        IDField.setFont(new Font(liter3, Font.PLAIN, 18));
        ...
        lblX.setFont(new Font(liter2, Font.PLAIN, 23));
